...
class Cart extends React.Component {
  ...
  handleDelete = async (id, e) => {
    ...
    const alerts = Swal.mixin({
      customClass: { confirmButton: "btn-auth btn btn-warning" },
    });
    await axios
      ...
      .catch((err) => {
        console.log({ err });
        alerts.fire({ icon: "error", text: `err` });
      });
  };
        ...
        >
          <div className="card  text-center cardresto mb-5">
            ...
            <div className="card-body text-center">
              ...
              <button
                onClick={(e) => this.handleDelete(this.props.id_cart, e)}
                type="button"
