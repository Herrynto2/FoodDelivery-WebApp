            ...
            <div className="col-lg-3">
                <Link to={`/detail-items/${this.props.id}`} className="text-decoration-none" >
                    <div className="card  text-center cardresto mb-5" >
                        ...
                        <div className="card-body text-center" >
                            <img onClick={(e) => { this.handleModal(e) }} src={cart} alt="" className="imgcart" />
                ...
                {this.props.data_item && (
                    <Modal centered show={this.state.show} onHide={() => this.setState({ show: false })}>
                        <Modal.Header closeButton><span className="bold text-muted" > {this.props.data_item.name_restaurant} </span>
                        </Modal.Header >
                                ...
                                <div class="row no-gutters" >
                                    ...
                                    <div class="col-md-8 text-left" >
                                        <div class="card-body card-bodies" >
                                            <h6 className="cart-prices" > Rp. {this.props.data_item.price} <span className="peritem" > /item</span >
                                            </h6>
