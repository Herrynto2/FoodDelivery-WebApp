                            ...
                            <div className='col-lg-9' >
                                <div className="reviews-box" >
                                    <Media className="text-left" >
                                        <Media left >
                                            <img src={this.props.images} className="img-reviews" />
                                            <div className="trash" > < img src={Trash} onClick={e => this.handleDelete(this.props.id)}
                                                className="trash" />
                                            </div>
                                        </Media>
                                        <Media body >
                                            ...
                                            <p className="text-muted datereview" > Date Creted: {this.props.date_created} </p> <span className="reviewerComn" > {this.props.review} </span>
                                        </Media>
                                    </Media>
                                </div>
                            </div>
