                                ...
                                <div className="row" >
                                    <div className="col-lg formforgot pl-5 pr-5 pt-5" >
                                        <div class="form-group" >
                                            <label for="exampleFormControlInput1" className="text-dark gray" > Username </label> <input type="username" onChange={e => this.handleUsername(e)} className="form-control" id="exampleFormControlInput1" placeholder="username ..." />
                                            <label for="exampleFormControlInput1" className="mt-3" > New password </label> <input type="password"
                                                onChange={e => this.handleNewPassword(e)} className="form-control" id="exampleFormControlInput1" placeholder="password ..." />
                                            <label for="exampleFormControlInput1" className="mt-3" > Confirm password </label> <input type="password" onChange={e => this.handleConfirmPassword(e)} className="form-control" id="exampleFormControlInput1" placeholder="password ..." />
                                        </div>
                                        <div className="text-center" >
                                            <button type="button" onClick={e => this.handleSend(e)} className="btn-auth btn btn-warning mt-2" > Send </button>
                                        </div>
